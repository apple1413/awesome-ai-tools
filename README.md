...
- [BPM Finder](https://bpmfinder.io) - Free online BPM finder that detects tempo, key, meter, and beat positions from any track, then turns the analysis into an AI music generation brief.
